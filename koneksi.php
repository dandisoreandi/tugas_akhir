...
<?php
$tbfaktorlain="tbfaktorlain";
$id_faktorlain="id_faktorlain";

function FAK($tbfaktorlain,$id_faktorlain){
global $koneksi;
$query7 = mysqli_query($koneksi, "select * from $tbfaktorlain where id_faktorlain='$id_faktorlain'") or die (mysqli_error());
 $r7 = mysqli_fetch_array($query7);
$nama_faktorlain=$r7["nama_faktorlain"];
return $nama_faktorlain;
