...
if(isset($_POST['Simpan'])){
  ...
  if($querytambah) {
   ...
   echo"<script>alert('Data Berhasil di Input');location.href='$_SERVER[PHP_SELF]?module=jenis';</script>";
...
$queryupdate = mysqli_query($koneksi, "UPDATE tbpenyakit SET 
  ...
  if($queryupdate) {
   // header('location: menu.php');   
   echo"<script>alert('Data Berhasil di Update');location.href='$_SERVER[PHP_SELF]?module=jenis';</script>";
   
   
   } else{
   echo"<script>alert('Data Gagal di Update');location.href='$_SERVER[PHP_SELF]?module=jenis&stt=edit&id=$id_penyakit';</script>";
